      ...
      <div id="page">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy._core.tests.test_item_selection.source.html#l29">
                  <tt><i>29</i>             <span class="c1"># ta works, even if the array may be odd if buffer interface is used</span></tt>
               </a>
            </li>
            </ul>
         </li>
