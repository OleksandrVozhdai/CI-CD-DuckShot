      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy._core.tests.test_abc.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy._core.tests.test_abc.source.html#l8">
                  <tt><i>8</i> <span class="k">class</span><span class="w"> </span><span class="nc">TestABC</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
