...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\cv2\version.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.cv2.version.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.cv2.version.source.html#l5">
                  <tt><i>5</i> <span class="n">ci_build</span> <span class="o">=</span> <span class="kc">True</span></tt>
               </a>
            </li>
            </ul>
         </li>
