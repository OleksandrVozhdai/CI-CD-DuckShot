...
class ImageButton:
    def __init__(self, x, y, width, height,
        ...
        if hover_image_path:
            ...
            self.hover_image = (pygame.transform
                                .scale(self.hover_image,
                                       (width, height)))
    ...
    def draw(self, screen):
        current_image = self.hover_image if self.is_hovered \
            else self.image
    ...
    def handle_event(self, event):
        if (event.type == pygame.MOUSEBUTTONDOWN
            ...
            if self.sound and self.settings:
                # Отримуємо гучність з налаштувань
            ...
            pygame.event.post(pygame.event
                              .Event(pygame.USEREVENT, button=self))